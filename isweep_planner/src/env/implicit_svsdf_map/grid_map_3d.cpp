#include "isweep_planner/env/map_manager/GridMap3D.h"
...
void GridMap3D::releaseMemory()
{
    ...
    delete[] grid_esdf;
    delete[] grid_esdf_buffer1;
    delete[] grid_esdf_buffer2;
    grid_map = nullptr;
    grid_map_buffer_neg = nullptr;
    grid_map_buffer_all = nullptr;
    grid_map_flags = nullptr;
    grid_esdf = nullptr;
    grid_esdf_buffer1 = nullptr;
    grid_esdf_buffer2 = nullptr;
