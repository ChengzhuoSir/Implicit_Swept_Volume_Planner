#include <esv_planner/optimization/svsdf_backend/planner_algorithm/back_end_optimizer.hpp>
                                  ...
                                  Trajectory<TRAJ_ORDER> &traj)
{
  ...
  param.terminate_param1 = 1.0e-4;   // relaxed from 1e-6
  param.terminate_param2 = 1.0e-4;   // relaxed from 1e-6
  param.delta_past       = 1.0e-5;   // relaxed from 1e-8
  param.max_stepsize     = 2.0;      // was 1.5
  param.bundle_size      = 4;        // was 2
  param.distance_measure = 0.1;      // was 0.5
